...
class VL53L0X {
 public:
    ...
    void setBus(i2c_inst_t *bus) { this->bus = bus; }
    i2c_inst_t *getBus() { return bus; }
    ...
    void writeMulti(uint8_t const *src, uint8_t count);
    ...
    inline uint32_t getTimeout() { return io_timeout; }
